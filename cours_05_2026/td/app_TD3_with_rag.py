...
Usage:
  python app_TD3_with_rag.py --model <model>
"""
...
from src.agent_openai_rag import AgentConfig
from src.agent_openai_rag import FileAgentOpenAIRAG as FileAgent
...
Commandes disponibles:
  ...
  /memory         Affiche les dernières notes de mémoire persistante
  /wm             Affiche la mémoire de travail courante
""")
    ...
    while True:
        ...
        if user_input.startswith("/"):
            ...
            if cmd == "/exit":
                ...
                for rec in agent.memory_store.records[-10:]:
                    print("-", rec["kind"], "|", rec["text"])

            elif cmd == "/wm":
                print("Working memory:")
                print(agent.working_memory.summary_text() or "(empty)")
