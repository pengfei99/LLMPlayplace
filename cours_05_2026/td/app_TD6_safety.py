...
from src.agent_langgraph_safety import AgentConfig
from src.agent_langgraph_safety import FileAgentLangGraphSafety as FileAgent
...
from src.tools_safety import default_config

# Usage:
# python app_TD6_safety.py --model <model>
...
Commandes disponibles:
  ...
  /approve         Approuve le tool call en attente
  /reject          Rejette le tool call en attente
  /checkpoints     Liste les checkpoints disponibles
  /checkpoint ID   Affiche le détail d'un checkpoint
  /replay ID       Rejoue depuis un checkpoint
""")
...
def main() -> None:
    ...
    agent_cfg = AgentConfig(
        ...
        interrupt_on_tools={"write_text_file", "remember_note"},
    )
